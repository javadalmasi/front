<template>
    <div class="flex flex-col items-center gap-6 page-container py-8">
            ...
            <div class="w-full flex items-center gap-2">
                ...
                <div class="relative flex-1">
                    <input
                        ...
                        class="h-12 input-base w-full pl-12 !rounded-full"
                        type="search"
                        ...
                        @keyup="onKeyUp"
                    />
                    <div class="i-fa6-solid:magnifying-glass absolute left-4 top-1/2 text-soft -translate-y-1/2"></div>
                </div>

                <!-- Submit Button -->
                <button class="h-12 btn btn-primary" @click="submitSearch">
                    {{ $t("actions.search") }}
                </button>
            </div>
