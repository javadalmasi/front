<template>
    <div v-if="showVideo" class="card h-full flex flex-col overflow-hidden transition-all duration-200 hover:shadow-lg">
        <!-- Video Thumbnail -->
        ...
        <div class="p-3 flex gap-3 flex-1">
            ...
            <router-link v-if="item.uploaderAvatar && !hideChannel" :to="item.uploaderUrl" class="flex-shrink-0">
                <div class="relative">
                    <img
                        ...
                        class="w-9 h-9 rounded-full bg-surface"
                        alt=""
                    />
                    <div
            ...
            <div class="overflow-hidden">
                ...
                <div class="mt-1.5 text-sm text-soft flex flex-col">
                    <router-link
