...
16. **`/playlists` (لیست‌های پخش)** - لیست لیست‌های پخش ایجاد شده یا ذخیره شده توسط کاربر را نمایش می‌دهد و از کامپوننت PlaylistsPage.vue استفاده می‌کند.

17. **`/:pathMatch(.*)*` (صفحه یافت نشد)** - یک مسیر همه‌کاره که خطاها را در مورد URLهای نامatching مدیریت می‌کند و پیام "صفحه یافت نشد" را نمایش می‌دهد و از کامپوننت PageNotFound.vue استفاده می‌کند.