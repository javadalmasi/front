...
export default defineConfig({
    ...
    shortcuts: {
        ...
        'btn-secondary': 'bg-gray-200 text-text-primary hover:bg-gray-300 dark:bg-dark-secondary dark:text-dark-text-primary dark:hover:bg-opacity-80',
        ...
        // Inputs
        'input-base': 'w-full px-3 py-2 bg-transparent border border-color rounded-DEFAULT text-main placeholder:text-soft focus:outline-none focus:ring-2 focus:ring-primary',
